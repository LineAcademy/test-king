...
<head>
    ...
    <title>The King TUT Test Demo</title>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Epilogue%3Aital%2Cwght%400%2C100%3B0%2C200%3B0%2C300%3B0%2C400%3B0%2C500%3B0%2C600%3B0%2C700%3B0%2C800%3B0%2C900%3B1%2C100%3B1%2C200%3B1%2C300%3B1%2C400%3B1%2C500%3B1%2C600%3B1%2C700%3B1%2C800%3B1%2C900&#038;display=swap"
    ...
    <div class="onovo-page footer--fixed">
        ...
        <div class="preloader">
            <div class="preloader__spinner">
                <img class="logo--white" src="assets/images/logo.png" alt="Onovo" />
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-3 align-self-center">
                            ...
                            <!-- Logo -->
                            <div class="onovo-logo-image" style="max-width: 100%">
                                <a href="index.html">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide" data-swiper-autoplay>
							<div class="onovo-hero-slide-item">
								<div class="image" data-dimg="assets/images/fre.jpeg" data-mimg="assets/images/fre.jpeg">
								...
								<div class="container">
									<div class="titles">
										<h1 class="title onovo-text-white">
											<span data-splitting> 
                                                Explore Unforgettable Landscapes </span>
										</h1>
										<div class="text">
						...
						<div class="swiper-slide" data-swiper-autoplay>
							<div class="onovo-hero-slide-item">
								<div class="image" data-dimg="assets/images/frv.jpg" data-mimg="assets/images/frv.jpg">
									<div class="ovrl" style="opacity: 0.95;"></div>
								</div>
								<div class="container">
									<div class="titles">
						...
						<div class="swiper-slide" data-swiper-autoplay>
							<div class="onovo-hero-slide-item">
								<div class="image" data-dimg="assets/images/ff.png" data-mimg="assets/images/ff.png">
									<div class="ovrl" style="opacity: 0.95;"></div>
								</div>
								<div class="container">
									<div class="titles">
										<h1 class="title onovo-text-white">
											<span data-splitting> The King TUT &amp; g <br />TUT </span>
										</h1>
										<div class="text">
											<div class="subtitle onovo-text-white subtitle--left">
												<div data-splitting> We build readymade websites, mobile apps <br>and elaborate online business services. </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <p>From the moment our company was founded we have helped our clients find <strong>exceptional solutions for their businesses</strong> memorable brands and digital products. Our expertise grows with each year, and our
                                    ...
                                    <div class="swiper-container js-reviews-carousel" data-loop="false">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide onovo-reviews-item" data-swiper-autoplay>
                                                <div class="text">
                                                    <div data-splitting>
                                                        <p>“ Their high level of customer service <br />complemented their technical expertise. <br />They were responsive, supportive, and <br />communicative. Their dedication to <br />the project was impressive.
                                                            ” </p>
                                                    </div>
                                                </div>
                                                <h5 class="title">
